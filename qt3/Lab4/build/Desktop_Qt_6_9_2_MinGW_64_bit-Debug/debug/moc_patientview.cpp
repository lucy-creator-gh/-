...
namespace {
struct qt_meta_tag_ZN11PatientViewE_t {};
} // unnamed namespace

template <> constexpr inline auto PatientView::qt_create_metaobjectdata<qt_meta_tag_ZN11PatientViewE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<PatientView, qt_meta_tag_ZN11PatientViewE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject PatientView::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11PatientViewE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11PatientViewE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN11PatientViewE_t>.metaTypes,
    nullptr
} };
...
void PatientView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_btDelete_clicked(); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (PatientView::*)(int )>(_a, &PatientView::goPatientEditView, 0))
            return;
    }
}
...
void *PatientView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11PatientViewE_t>.strings))
