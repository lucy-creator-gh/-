...
public:
    ...
    void setupUi(QWidget *MasterView)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/image/back.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        btBack->setIcon(icon);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/image/logout.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
